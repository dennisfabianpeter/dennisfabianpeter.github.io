...
if(windowWidth<900){
    ortho(-width / (windowWidth/200), width /(windowWidth/200), height/ (windowWidth/200), -height/ (windowWidth/200), -100000, 100000);
}

else{
        ortho(-width / (windowWidth/500), width /(windowWidth/500), height / (windowWidth/500), -height / (windowWidth/500), -100000, 100000);
  }
